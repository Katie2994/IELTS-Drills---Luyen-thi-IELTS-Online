...
const Hero = () => {
    return (
        <section className="relative pt-32 pb-12 lg:pt-40 lg:pb-20 px-4 sm:px-6 overflow-hidden min-h-[auto] flex flex-col justify-center">
            <div className="container mx-auto max-w-7xl">
                {/* Intro Text */}
                <div className="mb-10 lg:mb-14 text-center lg:text-left animate-fade-in-down">
                ...
                {/* Bento Grid Layout */}
                <div className="grid grid-cols-1 md:grid-cols-12 gap-6 animate-fade-in-up" style={{ animationDelay: '200ms' }}>
