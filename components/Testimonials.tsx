    ...
    return (
        <section id="testimonials" className="py-24 bg-brand-gray">
            <div className="container mx-auto px-6">
                ...
                >
                    <h2 className="text-3xl sm:text-4xl font-extrabold text-brand-black">Gia Nhập Cùng Hàng Ngàn Học Viên Thành Công</h2>
                    <p className="text-base sm:text-lg text-gray-600 mt-4 max-w-2xl mx-auto">Xem IELTS Drills đã giúp những học viên như bạn đạt được ước mơ như thế nào.</p>
                </div>
